...
<iframe src="ResearchPaper.pdf #toolbar=0&amp;navpanes=0" width="100%" height="900px" style="border: none;">
...
`<iframe src="`{=html}Cruikshank`.pdf #toolbar=0&amp;navpanes=0" width="100%" height="900px" style="border: none;">`{=html}
